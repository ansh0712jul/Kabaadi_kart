...
function ProfilePage() {
    ...
    const userData = {
        ...
        collectorPhoneNumber: "987-654-3210",
        pickupImage: "https://example.com/path/to/pickup-image.jpg"
    };
                ...
                <div className="mt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-white p-6 rounded-lg shadow-md w-full">
                            ...
                            <div className="mt-4">
                                <img src={userData.pickupImage} alt="Pickup" className="w-24 h-24 rounded-full mx-auto mb-4" />
                                <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center justify-between mt-2">
                                    ...
                                    <span className="text-gray-800">{userData.collectorName}</span>
                                </div>
                                <div className="flex items-center justify-between mt-2">
                                    <span className="text-gray-600">Collector Phone Number</span>
                                    <span className="text-gray-800">{userData.collectorPhoneNumber}</span>
                                </div>
